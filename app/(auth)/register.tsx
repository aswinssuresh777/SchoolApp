                      ...
                      <DateTimePicker
                        ...
                        onChange={(event: any, selectedDate?: Date) => {
                          ...
                          if (selectedDate) {
                            ...
                            // Get timezone offset in minutes (e.g., -330 for IST) and convert to milliseconds
                            const offsetInMs = localDate.getTimezoneOffset() * 60 * 1000;
                            // Subtract the offset to adjust the time to local midnight equivalent in UTC
                            const correctedDate = new Date(localDate.getTime() - offsetInMs);
                            setFormData({ ...formData, dob: correctedDate });
                          }
                        }}
                      />
                    )}
